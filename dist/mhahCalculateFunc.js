...
export class MhahCalculateFunc {
    calculate(d, mhahConstant) {
        ...
        let inpmin = Math.floor(d.getMinutes());
        if (inpmin < 10)
            inpmin = '0' + inpmin;
        ...
        // Karana
        let KaranaArray = this.getKarana(mhahPanchangImpl.Lmoon, mhahPanchangImpl.Lsun);
        n_karana = KaranaArray[0];
        let nk = KaranaArray[1];
        let s_karana = mhahPanchangImpl.tithi(jd, nk, tzone, 6);
        let z = this.getRaasi(mhahPanchangImpl, mhahPanchangImpl.Lmoon, mhahPanchangImpl.ayanamsa);
    ...
    getNakshatra(mhahPanchangImpl, Lmoon, ayanamsa) {
        let Lmoon0 = mhahPanchangImpl.fix360(Lmoon + ayanamsa);
        return Math.floor((Lmoon0 * 6) / 80);
    }
    getZYoga(mhahPanchangImpl, ayanamsa, jd) {
    ...
    getRaasi(mhahPanchangImpl, Lmoon, ayanamsa) {
